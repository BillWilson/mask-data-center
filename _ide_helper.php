 ...
 * Generated for Laravel 6.14.0 on 2020-02-05 19:15:30.
 *
...
namespace Kreait\Laravel\Firebase\Facades { 
    ...
    class FirebaseAuth {
        ...
        {
                        /** @var \Kreait\Firebase\Auth $instance */
                        $instance->verifyPasswordResetCode($oobCode);
        }
        ...
        {
                        /** @var \Kreait\Firebase\Auth $instance */
                        $instance->confirmPasswordReset($oobCode, $newPassword, $invalidatePreviousSessions);
        }
